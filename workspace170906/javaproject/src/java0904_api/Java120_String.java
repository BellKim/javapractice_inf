...
public class Java120_String {
	...
	private static void handleMessage(String str) {
		...
		String[] head_arr = new String[] {"제품아이디", "제품명", "가격", "수량", "제조사"};
		String[] product_sep = str.split(":");
		
		for(int i=0; i<product_sep.length; i++) {
			System.out.printf("%s : %s\n",head_arr[i],product_sep[i]);
