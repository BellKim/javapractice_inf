...
class Sales {
	...
	public String toString() {	//==> 출력->  품목 : apple 수량 : 5 단가 : 1200원 금액 : 6000원
		
		return "품목 : "+this.item+" 수량 : "+this.qty+" 단가 : "+ this.cost+"원 금액 : "+this.cost*this.qty;
	}
	
	public int getPrice() {	//수량 * 단가를 리턴
