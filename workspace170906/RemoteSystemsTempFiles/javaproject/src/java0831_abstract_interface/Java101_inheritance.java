...
class Bird extends Pet {
	...
	public boolean isFlightYN() {
		return flightYN;
	}

	public void setFlightYN(boolean flightYN) {
...
public class Java101_inheritance {
	...
	public static void main(String[] args) {
		...
		Bird bird = new Bird();
		bird.setType("앵무새");
		bird.setFlightYN(true);

		//////////////////////////////////////////////

		// 실행할때 아래 부분의 주석을 해제하세요.
		
		  System.out.println("강아지의 이름은 " + dog.name + "고, 몸무게는 " + dog.getWeight() +
		  "Kg입니다."); System.out.println("새의 종류는 " + bird.type + "고, 날 수 " +
		  (bird.getFlight() ? "있" : "없") + "습니다");
